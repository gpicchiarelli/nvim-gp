...
local function status_safe(value)
  value = tostring(value or "n/d")
  value = value:gsub("[\r\n\t]", " ")
  value = value:gsub("%%", "%%%%")
  value = value:gsub("[<>]", "")
  value = value:gsub("%s+", " ")
...
function M.status_cpu()
  return status_safe("CPU " .. M.snapshot().load)
end

function M.status_ram()
  return status_safe("RAM " .. M.snapshot().ram)
end
...
function M.status_net()
  ...
  return status_safe("NET " .. ip)
end

function M.status_safe(value)
  return status_safe(value)
end
